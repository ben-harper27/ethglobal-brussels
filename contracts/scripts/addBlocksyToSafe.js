...
const safeAddress = "0x9754B56ab0BF8D59E9384ce3318Dc33220dA320f";
const hoaContractAddress = "0x902d2B63F4eb51c17838bc0E445865D0dA8C8f8b"

// Initialize Safe contract
const safeContract = new ethers.Contract(safeAddress, safeABI, signer);

async function main() {
    // Enable module (HOA contract)
    const result = await safeContract.enableModule(hoaContractAddress);
    await result.wait();
